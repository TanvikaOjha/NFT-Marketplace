...
import { TiSocialFacebook, TiSocialLinkedin, TiSocialYoutube,
        ...
        <div className={Style.AuthorProfileCard_box}>
            ...
            <div className={Style.AuthorProfileCard_box_info}>
                ...
                < div className={Style.AuthorProfileCard_box_info_address}>
                    <input type="text" value="0x829BD824B03D092293333..A830" id="myInput" />
                    <FiCopy onClick={() => copyAddress()} className={Style.AuthorProfileCard_box_info_address_icon}/>
                
            </div>
            <p>Punk #4786 / An OG Cryptopunk Collector, hoarder of NFTs. Contibuting to @ether_cards, an NFT monetisation Platform.</p>
