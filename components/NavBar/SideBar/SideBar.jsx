...
const SideBar = (setOpenSideMenu) => {
  ...
  return (
    <div className={Style.sideBar}>
      <GrClose onClick={() => closeSideBar()} className={Style.sideBar_closeBtn} />
      <div className={Style.sideBar_box}>
        <Image src={images.logo} alt='logo' width={150} height={150} />
        <p>The most outstanding Articles on all the topics of NFT & your own stories and share them</p>
